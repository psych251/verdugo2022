...
Key analysis of interest: Contrast in self-reported curiosity between Choice/Preferred and No-Choice/Preferred conditions.
...
# contrast 1: contrast choice/pref with no choice/pref
# choice/pref: (1, 0). no choice/pref: (0, -1)
# contrast 2: contrast no choice/pref with no choice/not pref
# no choice/pref: (1, 0). no choice/not pref: (0, -1)
